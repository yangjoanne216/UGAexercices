...
public class DictionnaireStringInt {
	private String[] cles = new String[10]; // 创建一个含有10个String的表格用于存储clés
	private int[] valeurs = new int[10];// 创建一个含有10个int类型的表格用于存储对应clé的valeurs
	...
	public void ajouterModifier(String clesAjoute,int valeurAjoute) {
